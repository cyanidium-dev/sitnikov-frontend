  ...
  return (
    <article className="h-full">
      <InfoBox variant="withImage" classname="relative h-full flex flex-col">
        ...
        <div className="absolute left-6 top-[177px] z-10 min-w-[210px] max-w-[298px] rounded-[8px] p-[1px] before:absolute before:inset-0 before:z-0 before:rounded-[8px] before:bg-gradient-to-br before:from-[#EAEBFF] before:to-[#091129] before:content-['']">
