...
const Header = () => {
  ...
  return (
    <header className="fixed z-10 w-dvw bg-black bg-opacity-40 py-6 backdrop-blur-lg will-change-transform supports-[backdrop-blur]:before:backdrop-blur-lg xl:py-[30.5px]">
