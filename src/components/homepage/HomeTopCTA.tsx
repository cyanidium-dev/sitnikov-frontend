  ...
  return (
    <section className="relative h-[616px] bg-dark bg-[url('/images/homepage/home-topCTA-bg.webp')] bg-cover bg-no-repeat pb-[54px] pt-16 text-light xl:h-[589px] xl:pt-[88px]">
      ...
      <AnimatedWrapper
        ...
        className="absolute -right-[178px] bottom-0 z-10 h-[566px] w-[454px] bg-[url('/images/homepage/home-topCTA-person-mob.webp')] bg-no-repeat xl:-right-[162px] xl:h-[861px] xl:w-[690px] xl:bg-[url('/images/homepage/home-topCTA-person-desk.webp')]"
      />
