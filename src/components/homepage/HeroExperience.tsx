      ...
      <div className="container max-w-[1280px] max-md:max-w-[400px]">
        <div className="mb-10">
          <div className="flex flex-col gap-5">
            <h2 className="font-micra text-2xl leading-[1.22]">{t("title")}</h2>
        ...
        <div className="max-md:-mx-8">
          <div className="relative mb-16 h-[174px] max-md:mx-auto max-md:w-screen max-md:max-w-[400px] md:h-[328px]">
            <Image
