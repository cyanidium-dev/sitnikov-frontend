...
const HeroTopCTA = async () => {
  ...
  return (
    <section className="relative h-[616px] bg-dark bg-[url('/images/homepage/hero-topCTA-bg.webp')] bg-cover bg-no-repeat pb-[54px] pt-16 text-light max-xl:overflow-x-auto xl:h-[589px] xl:pt-[88px]">
      <div className="container relative z-20 max-w-[1280px]">
        ...
        <ButtonOrLink className="max-w-[374px] bg-light text-dark">
          {t("button")}
        </ButtonOrLink>
      </div>
