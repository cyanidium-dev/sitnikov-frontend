...
const HomeBottomCTA = async () => {
  ...
  return (
    <section className="relative mb-[120px] bg-[url('/images/homepage/home-bottomCTA-bg.webp')] bg-cover bg-no-repeat pb-[26px] pt-16 text-light xl:mb-[200px] xl:h-[589px] xl:h-[623px] xl:pt-[88px]">
