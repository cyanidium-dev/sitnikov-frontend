...
const EducationHero = async () => {
  ...
  return (
    <section className="relative h-[665px] bg-dark pt-[136px] text-light max-md:rounded-b-2xl md:h-[480px] xl:h-[520px]">
      ...
      <div className="absolute left-0 z-[5] h-[233px] w-full bg-cyan-400 max-md:bottom-0 max-md:rounded-b-2xl md:top-0 md:h-full md:w-[390px] xl:w-[532px]" />
      ...
      <div className="absolute bottom-0 left-[390px] h-[277px] w-[230px] max-md:hidden md:bg-[url('/images/educationPage/education-hero-decor-left-desk.webp')] xl:left-[532px]" />
    </section>
  );
};
