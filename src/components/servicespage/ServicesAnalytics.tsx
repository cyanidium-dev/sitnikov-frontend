...
const ServicesAnalytics = async () => {
  ...
  return (
    <section className="relative bg-dark py-16 pb-[120px] pt-[188px] text-light xl:pb-[87px] xl:pt-[136px]">
      ...
      <div className="absolute bottom-0 left-[65px] hidden bg-[url('/images/servicespage/services-analytics-themis.webp')] xl:block xl:h-[613px] xl:w-[557px]" />
      ...
      <div className="container max-w-[400px] md:max-w-[700px] xl:max-w-[1280px]">
        ...
        <ButtonOrLink className="bg-light text-dark xl:ml-auto xl:max-w-[509px]">
          {t("button")}
        </ButtonOrLink>
      </div>
    </section>
